...
import com.example.datagame.Adapter.CharactersAdapter;
...
//        });
    ...
    private void showWord(int i){
        CharactersAdapter charactersAdapter = new CharactersAdapter
                (com.example.datagame.MainActivity.this, shuffleWords(i),etWord);
            ...
            case R.id.btnOK:
                ...
                if(level+1<words.length) {
                    if (usr_word.equals(words[level])) {
                        ...
                        editor.commit();
                        etWord.setText("");
                        Toast.makeText(com.example.datagame.MainActivity.this, "Next Level", Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(com.example.datagame.MainActivity.this, "Wrong Word", Toast.LENGTH_SHORT).show();
                        etWord.setText("");
                        showWord(level);
                    }
                }
                    ...
                    editor.putInt("Level",level);
                    showWord(level);
                    Toast.makeText(com.example.datagame.MainActivity.this, "Game Over", Toast.LENGTH_SHORT).show();
                }
                break;
